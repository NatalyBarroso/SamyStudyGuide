export const modules_data = [
  {
    ...
    goals: [
      ...
      "Analizar e inferir fechas, lugares y contexto a partir de la información disponible en un texto.",
      "Distinguir la información esencial de la complementaria en un recuento histórico.",
      "Redactar un recuento histórico estructurado, claro y coherente."
    ],
