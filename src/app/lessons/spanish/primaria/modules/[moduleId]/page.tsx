...
export default function ModulePage({ params }: Props) {
  const currentModule = data_spanish_primaria.find(m => m.id === params.moduleId);
    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-start min-h-screen px-4 sm:px-8 md:px-12 lg:px-16 py-6 sm:py-8 text-base sm:text-lg">
        ...
        <div className="w-full font-[family-name:var(--font-cutive-mono)]">
          ...
          <p className="text-justify text-sm sm:text-base">{currentModule?.introduction}</p>
      ...
      <div className="hidden lg:flex lg:justify-end lg:px-16 lg:mt-8">
        <button className="w-14 h-14 bg-[var(--primary-color)] rounded-full shadow-lg flex items-center justify-center hover:bg-[var(--secondary-color)] transition-colors duration-300">
          <Image src="/icons/mingcute--right-line.svg" alt="Ir al siguiente" width={24} height={24} priority />
        </button>
      </div>
